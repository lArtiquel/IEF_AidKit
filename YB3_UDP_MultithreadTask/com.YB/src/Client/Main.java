...
public class Main extends Application{
    ...
    public void start(Stage stage){
        ...
        VBox tfBox = new VBox(lb, imageView, textFieldA, textFieldB, textFieldC, bsend);
        tfBox.setAlignment(Pos.CENTER);

        BorderPane root = new BorderPane(tfBox);     // add to the root vBox with textField, lb, bSend
